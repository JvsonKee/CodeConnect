...
`,Jy=y.div`
    ...
    width: 100%;
    height: 100%;
`;function u4(){const[e,t]=x.useState("Recent"),[n,r]=x.useState(!1),o=()=>{r(a=>!a)},i=te.slice().reverse();return u.jsxs(It,{children:[u.jsx(mn,{onPost:o}),u.jsx(Xy,{children:u.jsxs(Qy,{children:[u.jsxs(Zy,{children:[u.jsx(vl,{children:"Home"}),u.jsx(Kl,{setStatus:t})]}),u.jsx(Jy,{children:i.map((a,s)=>u.jsx(Aa,{information:a},s))})]})})]})}const c4=y.div`
    margin-left: 20vw;
    display: flex;
    width: 80vw;
    background-color: var(--black);
