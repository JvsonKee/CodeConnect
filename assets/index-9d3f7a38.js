...
`;y(Ze)`
    font-size: 17px;
    color: var(--white);
`;function $j({showForm:e,closeForm:t,onPostSuccess:n}){const[r,o]=x.useState({post_title:"",post_topic:"",post_desc:""}),[i,a]=x.useState(""),[s,u]=x.useState(""),[c,d]=x.useState(""),[f,h]=x.useState(!1),k="Please enter a title, topic, and description before posting!",w=p=>{const{name:v,value:m}=p.target;o({...r,[v]:m})},S=()=>{const{post_title:p,post_topic:v,post_desc:m}=r;if(p.trim()==""||v.trim()==""||m.trim()==""){h(!0);return}yb(p,v,m,"1 second ago"),localStorage.setItem("savedTitle",""),localStorage.setItem("savedDesc",""),localStorage.setItem("savedTopic","Web Development"),h(!1),t(),n()},j=()=>{const{post_title:p,post_topic:v,post_desc:m}=r;localStorage.setItem("savedTitle",p),localStorage.setItem("savedTopic",v),localStorage.setItem("savedDesc",m),alert("Saved draft for later! Come back to this screen when you're ready to continue")},g=()=>{const p=localStorage.getItem("savedTitle");p!=""&&(a(p),o(C=>({...C,post_title:p})));const v=localStorage.getItem("savedTopic");v!=""&&(u(v),o(C=>({...C,post_topic:v})));const m=localStorage.getItem("savedDesc");m!=""&&(d(m),o(C=>({...C,post_desc:m})))};return x.useEffect(()=>{g()},[]),l.jsxs(Dj,{centered:!0,size:"lg",show:e,animation:!0,scrollable:!0,children:[l.jsxs(Fj,{children:[l.jsx(En.Title,{children:"Create a New Post"}),l.jsx("button",{type:"button",className:"btn-close btn-close-white","aria-label":"Close",onClick:t})]}),l.jsxs(Ne,{children:[l.jsxs(En.Body,{children:[l.jsxs(Wi,{children:[l.jsx(Qn,{xs:8,children:l.jsxs(Ne.Group,{className:"mb-3",controlId:"postForm.title",children:[l.jsx(Ne.Label,{children:"Title"}),l.jsx("br",{}),l.jsx(Zm,{as:"textarea",rows:1,id:"post_title",name:"post_title",value:r.post_title,defaultValue:i,onChange:w})]})}),l.jsx(Qn,{xs:4,children:l.jsxs(Ne.Group,{className:"mb-3",controlId:"postForm.topic",children:[l.jsx(Ne.Label,{children:"Topic"}),l.jsx(Ne.Select,{id:"post_topic",name:"post_topic",value:r.post_topic,defaultValue:s,onChange:w,children:st.map((p,v)=>l.jsx("option",{value:p.getName(),children:p.getName()},v))})]})})]}),l.jsxs(Ne.Group,{className:"mb-3",controlId:"postForm.desc",children:[l.jsx(Ne.Label,{children:"Description"}),l.jsx(Zm,{as:"textarea",rows:5,id:"post_desc",name:"post_desc",value:r.post_desc,defaultValue:c,onChange:w})]})]}),l.jsxs(En.Footer,{children:[l.jsxs(Wi,{children:[l.jsx(Qn,{xs:6,children:l.jsx("input",{className:"form-control form-control",id:"formFile",type:"file"})}),l.jsx(Qn,{xs:4,children:l.jsx(ga,{variant:"secondary",onClick:j,children:"Save Form for Later"})}),l.jsx(Qn,{xs:2,children:l.jsx(ga,{variant:"primary",onClick:S,children:"Post"})})]}),f&&l.jsx("div",{style:{color:"red"},children:k})]})]})]})}function mn({onPost:e}){const[t,n]=x.useState(!1),r=()=>{n(!0)},o=()=>{n(!1)};return l.jsx(n3,{children:l.jsxs(r3,{children:[l.jsx(ki,{to:"/CodeConnect/home",children:l.jsxs(o3,{children:[l.jsx(i3,{children:"Code"}),l.jsx(a3,{children:"Connect"})]})}),l.jsxs(s3,{children:[l.jsxs(ki,{to:"/CodeConnect/home",children:[l.jsx(ds,{icon:B1}),l.jsx("span",{children:"Home"})]}),l.jsxs(ki,{to:"/CodeConnect/explore",children:[l.jsx(ds,{icon:H1}),l.jsx("span",{children:"Explore"})]}),l.jsxs(ki,{to:"/CodeConnect/direct-messages",children:[l.jsx(ds,{icon:JE}),l.jsx("span",{children:"Messages"})]}),l.jsxs(ki,{to:"/CodeConnect/profile/PixelPioneer",children:[l.jsx(ds,{icon:XE}),l.jsx("span",{children:"Profile"})]}),l.jsx(l3,{onClick:r,children:"Post"}),t&&l.jsx($j,{showForm:t,closeForm:o,onPostSuccess:e})]})]})})}const zj=y.div`
    display: flex;
    justify-content: center;
    align-items: center;
    width: 20vw;
...
`,Oy=y.div`
  ...
  border-radius: 50px;
  cursor: pointer;
`;function Jl(){const[e,t]=x.useState(!1),n=lt(),r=()=>{n("/CodeConnect/create-account")},o=()=>{t(!1)};return l.jsxs(zj,{children:[l.jsxs(Uj,{children:[l.jsxs(Bj,{to:"/CodeConnect/home",children:[l.jsx(Hj,{children:"Code"}),l.jsx(Wj,{children:"Connect"})]}),l.jsxs(Yj,{children:[l.jsxs(qm,{to:"/CodeConnect/guest-home",children:[l.jsx(Jm,{icon:B1}),l.jsx("span",{children:"Home"})]}),l.jsxs(qm,{to:"/CodeConnect/guest-explore",children:[l.jsx(Jm,{icon:H1}),l.jsx("span",{children:"Explore"})]}),l.jsx(Vj,{onClick:r,children:"Create Account"})]})]}),e&&l.jsx(Ty,{children:l.jsxs(Ry,{children:[l.jsx(Ny,{children:"Please create an account to access this feature "}),l.jsx("div",{}),l.jsx("div",{}),l.jsx(Iy,{children:"Create Account"}),l.jsx(Oy,{onClick:o,children:"Close"})]})})]})}const Ay=y.div`
    display: flex;
    justify-content: center;
...
`;y(Ze)`
    font-size: 17px;
    color: var(--white);
`;function cp({data:e}){const[t,n]=x.useState(""),r=lt(),o=()=>{const a=e.filter(s=>s.title.toLowerCase().includes(t.toLowerCase()));r(`/CodeConnect/explore-results/${t}`,{state:{results:a,searchTerm:t}})},i=a=>{a.key==="Enter"&&o()};return l.jsx(Ay,{children:l.jsx(Zj,{input:"text",placeholder:"Search",value:t,onChange:a=>n(a.target.value),onKeyDown:i})})}cp.propTypes={data:H.object};const Ly=y.div`
    display: flex;
    justify-content: center;
    align-items: center;
    margin-left: 20vw;
...
`;function My({topicName:e}){const t=lt(),n=()=>{let r=[];st.forEach(o=>{o.name===e&&o.posts.forEach(i=>{r.push(i)})}),t(`/CodeConnect/explore-results/${e}`,{state:{results:r,searchTerm:e}})};return l.jsx(i5,{onClick:n,children:e})}My.propTypes={topicName:H.string};const a5="/CodeConnect/assets/web-dev-0661792e.png",s5="/CodeConnect/assets/game-dev-bd8da6b7.png",l5="/CodeConnect/assets/programming-d8860b21.png";console.log({postDatabase:re});function tg({isGuestView:e}){x.useState("Recent"),x.useState("");const t=lt(),n=r=>{let o=[];st.forEach(i=>{i.name===r&&i.posts.forEach(a=>{o.push(a)})}),t(`/CodeConnect/explore-results/${r}`,{isGuestView:e,state:{results:o,searchTerm:r}})};return l.jsxs(It,{children:[e?l.jsx(Jl,{}):l.jsx(mn,{}),l.jsx(Ly,{children:l.jsxs(Jj,{children:[l.jsx(cp,{data:re}),l.jsxs(qj,{children:[l.jsx(eg,{children:l.jsx(vl,{children:l.jsxs("div",{children:[l.jsx(e5,{icon:QE})," Trending"]})})}),l.jsx(t5,{children:l.jsxs(n5,{children:[l.jsxs(Ju,{id:"slide-1",children:[l.jsx(qu,{src:l5}),l.jsx(ec,{onClick:()=>n("Python"),children:"Python"})]}),l.jsxs(Ju,{id:"slide-2",children:[l.jsx(qu,{src:s5}),l.jsx(ec,{onClick:()=>n("Game Development"),children:"Game Development"})]}),l.jsxs(Ju,{id:"slide-3",children:[l.jsx(qu,{src:a5}),l.jsx(ec,{onClick:()=>n("React"),children:"React"})]}),l.jsxs(r5,{children:[l.jsx("a",{href:"#slide-1"}),l.jsx("a",{href:"#slide-2"}),l.jsx("a",{href:"#slide-3"})]})]})}),l.jsx(eg,{children:l.jsx(vl,{children:"Topics"})}),l.jsx(o5,{children:st.map((r,o)=>l.jsx(My,{topicName:r.name},o))})]})]})})]})}const u5=y.p`
color: #FFF;
background-color: var(--black);
font-size: 60px;
font-style: normal;
font-weight: 300;
line-height: normal;
`,c5=({children:e})=>l.jsx(u5,{children:e}),d5=y.p`
color: #8F8F8F;
background-color: var(--black);
font-size: 16px;
font-style: normal;
font-weight: 500;
line-height: normal;
`,f5=({children:e})=>l.jsx(d5,{children:e}),p5=y.p`
color: #FFF;
font-size: 14px;
font-style: normal;
font-weight: 500;
...
background: var(--black)
`,h5=({children:e})=>l.jsx(p5,{children:e}),m5=y.div`
    display: flex;
    width: 287px;
    padding: 4px 8px;
    align-items: center;
    gap: 20px;
`,g5=e=>l.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:25,height:24,fill:"none",...e,children:[l.jsx("g",{clipPath:"url(#a)",children:l.jsx("path",{stroke:"#fff",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9.5 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7a5.44 5.44 0 0 0-1.5-3.75A5.07 5.07 0 0 0 20.41 1S19.23.65 16.5 2.48a13.38 13.38 0 0 0-7 0C6.77.65 5.59 1 5.59 1a5.07 5.07 0 0 0-.09 3.77A5.44 5.44 0 0 0 4 8.55c0 5.42 3.3 6.61 6.44 7a3.37 3.37 0 0 0-.94 2.58V22"})}),l.jsx("defs",{children:l.jsx("clipPath",{id:"a",children:l.jsx("path",{fill:"#fff",d:"M.5 0h24v24H.5z"})})})]}),v5=e=>l.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:25,height:24,fill:"none",...e,children:[l.jsx("g",{clipPath:"url(#a)",children:l.jsx("path",{stroke:"#fff",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M23.5 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3.5 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5 0-.279-.028-.556-.08-.83A7.72 7.72 0 0 0 23.5 3Z"})}),l.jsx("defs",{children:l.jsx("clipPath",{id:"a",children:l.jsx("path",{fill:"#fff",d:"M.5 0h24v24H.5z"})})})]});function y5({network:e,username:t}){const n=()=>{switch(e){case"twitter":return l.jsx(v5,{});case"github":return l.jsx(g5,{})}};return l.jsxs(m5,{children:[n(),l.jsx(h5,{children:t})]})}const x5=y.div`
    display: flex;
    padding: 10px;
    flex-direction: column;
    align-items: flex-start;
    align-self: stretch;
`;function w5({username:e,biography:t,socialLinks:n}){return l.jsxs(x5,{children:[l.jsx(c5,{children:e}),l.jsx(f5,{children:t}),n.map((r,o)=>l.jsx(y5,{network:r.getSocialMedia(),username:r.getUsername()},o))]})}const k5=y.img`
  width:200px;
  height:200px;
  align-self: stretch;
  object-fit: cover;
  border-radius: 300px;
`;function S5({imageUrl:e}){return l.jsx(k5,{src:e,alt:"Profile"})}const b5=y.div`
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 16px;
    align-self: stretch;
`;function C5({user:e}){return l.jsxs(b5,{children:[l.jsx(S5,{imageUrl:e.getProfilePicture()}),l.jsx(w5,{username:e.getUsername(),biography:e.getBiography(),socialLinks:e.getSocialMedia()})]})}const E5=y.div`
    display: flex;
    padding: 6px;
    align-items: flex-start;
    gap: 10px;
...
font-weight: 400;
line-height: normal;
`;function P5({role:e}){return l.jsx(E5,{children:l.jsx(j5,{children:e})})}const T5=y.div`
    display: flex;
...
`,N5=y.p`
    ...
    align-self: stretch;
    background: #314B7E;
`;function I5({topicName:e}){return l.jsx(R5,{children:l.jsx(N5,{children:e})})}function O5({interests:e}){return l.jsx(T5,{children:e.map((t,n)=>l.jsx(I5,{topicName:t},n))})}const A5=y.div`
    display: flex;
    padding: 10px 4px;;
    justify-content: center;
    align-items: center;
...
`,L5=y.div`
    ...
    background: #252527;
`,M5=e=>l.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:16,height:16,fill:"none",...e,children:l.jsx("path",{stroke:"#fff",strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 8.667a.667.667 0 1 0 0-1.334.667.667 0 0 0 0 1.334ZM12.667 8.667a.667.667 0 1 0 0-1.334.667.667 0 0 0 0 1.334ZM3.333 8.667a.667.667 0 1 0 0-1.334.667.667 0 0 0 0 1.334Z"})});function _5(){const e={backgroundColor:"#3A3D4B",borderRadius:"8px",border:"1.5px solid #45484F"};return l.jsx(Dy,{style:e,children:l.jsx(_y,{children:"Settings"})})}function D5(){const e={backgroundColor:"#558FFF",borderRadius:"8px"},t={backgroundColor:"#558FFF"};return l.jsx(Dy,{style:e,children:l.jsx(_y,{style:t,children:"Message"})})}function F5({loggedInUser:e}){const t=()=>{switch(e){case!0:return l.jsx(_5,{});case!1:return l.jsx(D5,{})}};return l.jsxs(A5,{children:[t(),e?null:l.jsxs(L5,{children:[" ",l.jsx(M5,{})," "]})]})}const $5=y.div`
    display: flex;
    padding: 35px 22px;
    flex-direction: column;
    align-items: flex-start;
...
`;function z5({user:e}){return l.jsxs($5,{children:[l.jsx(P5,{role:e.role}),l.jsx(O5,{interests:e.interests}),l.jsx(F5,{loggedInUser:e.username==="PixelPioneer"})]})}const U5=y.div`
    display: flex;
    padding: 32px 32px;
    justify-content: center;
    align-items: center;
    ...
    align-self: stretch;
    background-color: var(--black);
`;function B5({user:e}){return l.jsxs(U5,{children:[l.jsx(C5,{user:e}),l.jsx(z5,{user:e})]})}const H5=y.div`
    width: 150px;
    align-self: stretch;
    background: #2B2D37;
`;function ng(){return l.jsx(H5,{})}const W5=y.div`  
    display: flex;
    padding: 32px 0px;
    flex-direction: column;
    justify-content: center;
...
`,Mo=y.div`
    ...
    gap: 10px;
    color: var(--grey);
`;var Gy={prefix:"far",iconName:"heart",icon:[512,512,[128153,128154,128155,128156,128420,129293,129294,129505,9829,10084,61578],"f004","M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z"]},Ky={prefix:"far",iconName:"comment",icon:[512,512,[128489,61669],"f075","M123.6 391.3c12.9-9.4 29.6-11.8 44.6-6.4c26.5 9.6 56.2 15.1 87.8 15.1c124.7 0 208-80.5 208-160s-83.3-160-208-160S48 160.5 48 240c0 32 12.4 62.8 35.7 89.2c8.6 9.7 12.8 22.5 11.8 35.5c-1.4 18.1-5.7 34.7-11.3 49.4c17-7.9 31.1-16.7 39.4-22.7zM21.2 431.9c1.8-2.7 3.5-5.4 5.1-8.1c10-16.6 19.5-38.4 21.4-62.9C17.7 326.8 0 285.1 0 240C0 125.1 114.6 32 256 32s256 93.1 256 208s-114.6 208-256 208c-37.1 0-72.3-6.4-104.1-17.9c-11.9 8.7-31.3 20.6-54.3 30.6c-15.1 6.6-32.3 12.6-50.1 16.1c-.8 .2-1.6 .3-2.4 .5c-4.4 .8-8.7 1.5-13.2 1.9c-.2 0-.5 .1-.7 .1c-5.1 .5-10.2 .8-15.3 .8c-6.5 0-12.3-3.9-14.8-9.9c-2.5-6-1.1-12.8 3.4-17.4c4.1-4.2 7.8-8.7 11.3-13.5c1.7-2.3 3.3-4.6 4.8-6.9c.1-.2 .2-.3 .3-.5z"]};function Aa({information:e}){const t=lt(),[n,r]=x.useState(!1),o=()=>{let s=e.getPostURL().url;localStorage.getItem("userDatabaseKey")!=null?t("/CodeConnect".concat(s)):t("/CodeConnect/guest-view".concat(s))},i=s=>{s.stopPropagation(),s.preventDefault(),n?(e.dislike(),r(!1)):(e.like(),r(!0))},a=s=>{s.stopPropagation(),s.preventDefault(),t("/CodeConnect/profile/"+e.author.getUsername())};return l.jsx(K5,{onClick:o,children:l.jsxs(X5,{children:[l.jsxs(Q5,{children:[l.jsxs(Fy,{children:[l.jsxs(J5,{onClick:a,children:[l.jsx($y,{src:e.author.getProfilePicture()}),l.jsx(zy,{children:e.author.getUsername()})]}),l.jsx(q5,{children:e.timestamp})]}),l.jsx(Z5,{children:e.reaction})]}),l.jsxs(Ia,{children:[l.jsx(Uy,{children:e.title}),l.jsx(Oa,{children:e.content})]}),l.jsx(By,{children:l.jsx(Hy,{children:l.jsx(Wy,{children:e.topic})})}),l.jsxs(Yy,{children:[l.jsxs(Mo,{children:[l.jsx("div",{onClick:i,children:n?l.jsx(Vy,{icon:U1}):l.jsx(yl,{icon:Gy})}),l.jsxs("div",{children:[e.likes," likes"]})]}),l.jsxs(Mo,{children:[l.jsx(yl,{icon:Ky}),l.jsxs("div",{children:[e.getCommentsTotal()," comments"]})]}),l.jsx(Mo,{children:". . ."})]})]})})}Aa.propTypes={information:H.object};const e4=y.div`
    display: flex;
...
`,t4=y.p`
    ...
    line-height: normal;
    align-self: stretch;
`;function n4(){return l.jsx(t4,{children:"Posts"})}function r4({posts:e}){return l.jsxs(e4,{children:[l.jsx(n4,{}),e.length>0?e.map((t,n)=>l.jsx(Aa,{information:t},n)):l.jsx(G5,{})]})}const o4=y.div`
    display: flex;
    justify-content: center;
    align-items: flex-start;
    flex: 1 0 0;
    align-self: stretch;
    background: #161314;
`;function i4({posts:e}){return l.jsxs(o4,{children:[l.jsx(ng,{}),l.jsx(r4,{posts:e}),l.jsx(ng,{})]})}const a4=y.div`
    width: 80vw;
    margin-left: 20vw;
    ...
    flex-direction: column;
    align-items: center;
`;function s4(){const{userName:e}=ei(),t=tn.find(n=>n.username==e);return l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(a4,{children:[l.jsx(B5,{user:t}),l.jsx(i4,{posts:t.getPosts()})]})]})}const l4=ib`
...
`,Jy=y.div`
    ...
    width: 100%;
    height: 100%;
`;function u4(){const[e,t]=x.useState("Recent"),[n,r]=x.useState(!1),o=()=>{r(a=>!a)},i=re.slice().reverse();return l.jsxs(It,{children:[l.jsx(mn,{onPost:o}),l.jsx(Xy,{children:l.jsxs(Qy,{children:[l.jsxs(Zy,{children:[l.jsx(vl,{children:"Home"}),l.jsx(Kl,{setStatus:t})]}),l.jsx(Jy,{children:i.map((a,s)=>l.jsx(Aa,{information:a},s))})]})})]})}const c4=y.div`
    margin-left: 20vw;
    display: flex;
    width: 80vw;
    background-color: var(--black);
...
`,P4=y.div`
   font-size: 25px;
   color: var(--white);
`;function zt({user:e,url:t}){const n=lt(),r=()=>{n(t)};return l.jsx(C4,{children:l.jsxs(E4,{onClick:r,children:[l.jsx(j4,{src:e.profilePic}),l.jsx(P4,{children:e.userName})]})})}const T4=y.div`
    font-size: 35px;
    font-weight: 600;
    color: var(--white);
...
`,R4={message:"Words words words words. Words words words.",userName:"Kirby",profilePic:Jr},N4={userName:"Boo",profilePic:qr},I4={userName:"Sonic",profilePic:Zr};function O4(){lt();const e="/CodeConnect/dm-boo",t="/CodeConnect/dm-kirby",n="/CodeConnect/dm-sonic";return l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(c4,{children:[l.jsx(d4,{children:l.jsxs(f4,{children:[l.jsxs(g4,{children:[l.jsx(T4,{children:"New Direct Message"}),l.jsx(b4,{to:"/CodeConnect/direct-messages",children:"X"})]}),l.jsxs(m4,{children:[l.jsx(x4,{rows:"2",cols:"30"}),l.jsx(y4,{children:"Search"})]}),l.jsx(v4,{children:l.jsx(w4,{rows:"2",cols:"30"})}),l.jsx(k4,{children:l.jsx(S4,{children:"Send"})})]})}),l.jsxs(p4,{children:[l.jsx(h4,{children:l.jsx(ql,{children:"Messages"})}),l.jsx(zt,{user:N4,url:e}),l.jsx(zt,{user:R4,url:t}),l.jsx(zt,{user:I4,url:n})]})]})]})}function A4(){localStorage.removeItem("userDatabaseKey");const[e,t]=x.useState("Recent"),n=re.slice().reverse();return l.jsxs(It,{children:[l.jsx(Jl,{}),l.jsx(Gj,{children:l.jsxs(Kj,{children:[l.jsxs(Xj,{children:[l.jsx(vl,{children:"Home"}),l.jsx(Kl,{setStatus:t})]}),l.jsx(Qj,{children:n.map((r,o)=>l.jsx(Aa,{information:r},o))})]})})]})}const L4=y.div`
...
`,W4=y.div`
    font-size: 19px;
    color: var(--grey);
`;function tc({user:e,targetUrl:t}){const n=lt(),r=()=>{n(t)};return l.jsx(F4,{onClick:r,children:l.jsxs($4,{children:[l.jsxs(z4,{children:[l.jsx(U4,{src:e.profilePic}),l.jsx(B4,{children:e.userName})]}),l.jsx(H4,{children:l.jsx(W4,{children:e.text})})]})})}const Y4=y.div`
    font-size: 50px;
    font-weight: 700;
    color: var(--white);
...
`,eu=y(gt)`
  ...
  cursor: pointer;
`,V4={userName:"Boo",text:"HAHAHHAHAHAH.",profilePic:qr},G4={userName:"Kirby",text:"Words words words words. Words words words.",profilePic:Jr},K4={userName:"Sonic",text:"Gotta go fast bro",profilePic:Zr};function X4(){lt();const e="/CodeConnect/dm-boo",t="/CodeConnect/dm-kirby",n="/CodeConnect/dm-sonic";return x.useState("Recents"),l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(L4,{children:[l.jsxs(M4,{children:[l.jsx(_4,{children:l.jsx(Y4,{children:"Direct Messages"})}),l.jsxs(D4,{children:[l.jsx(tc,{user:V4,targetUrl:e}),l.jsx(tc,{user:G4,targetUrl:t}),l.jsx(tc,{user:K4,targetUrl:n})]})]}),l.jsx(eu,{to:"/CodeConnect/new-direct-message",children:"New +"})]})]})}const Q4=y(It)`
    height: 100vh;
    justify-content: center;
    align-items: center;
`,Z4=y.div`
...
`,hp=y.div`
    flex: 1;
`;function mp({id:e,level1:t,level2:n,closeForm:r,onReplySuccess:o,isGuestView:i},a){const[s,u]=x.useState(!1),[c,d]=x.useState(!1),[f,h]=x.useState({reply_desc:""}),[k,w]=x.useState(!1),S="Please enter a description before replying!",j=m=>{const{name:C,value:T}=m.target;h({...f,[C]:T})},g=()=>{i?d(!0):u(!s)},p=()=>{const{reply_desc:m}=f;if(m.trim()==""){w(!0);return}const C=re[e];xb(C,t,n,m),w(!1),o(),g()},v=()=>{d(!1)};return l.jsxs(l.Fragment,{children:[l.jsx(mP,{variant:"outline-primary",className:"btn-sm",onClick:()=>g(),"aria-controls":"collapseOne","aria-expanded":s,children:"Reply"}),l.jsx("br",{}),c&&l.jsx(Ty,{children:l.jsxs(Ry,{children:[l.jsx(Ny,{children:"Please create an account to access this feature "}),l.jsx("div",{}),l.jsx("div",{}),l.jsx(Iy,{children:"Create Account"}),l.jsx(Oy,{onClick:v,children:"Close"})]})}),s&&l.jsxs(Ne,{children:[l.jsxs(Wi,{children:[l.jsx(Qn,{xs:11,children:l.jsx(Ne.Group,{className:"mb-3",controlId:"replyForm.desc",children:l.jsx(Ne.Control,{as:"textarea",rows:5,id:"reply_desc",name:"reply_desc",value:f.reply_desc,onChange:j,placeholder:"I've got some thoughts on this..."})})}),l.jsxs(Qn,{xs:1,children:[l.jsx(Wi,{children:l.jsxs(ga,{variant:"danger",className:"btn-sm",onClick:()=>u(!1),children:["Exit ",l.jsx(og,{icon:t3,size:"xl"})]})}),l.jsx("br",{}),l.jsx(Wi,{children:l.jsxs(ga,{variant:"secondary",className:"btn-sm",onClick:p,children:["Reply ",l.jsx(og,{icon:ZE,size:"xl"})]})})]})]}),k&&l.jsx("div",{style:{color:"red"},children:S})]})]})}function gP({handleRerenderThread:e,isGuestView:t}){const[n,r]=x.useState(!1),[o,i]=x.useState(!1),{id:a}=ei(),s=lt(),u=re[a],c=u.author.getProfilePicture(),d=u.author.getUsername(),f=()=>{r(!1)},h=w=>{w.stopPropagation(),w.preventDefault(),o?(u.dislike(),i(!1)):(u.like(),i(!0))},k=w=>{w.stopPropagation(),w.preventDefault(),s("/CodeConnect/profile/"+u.author.getUsername())};return l.jsx(dP,{children:l.jsxs(fP,{children:[l.jsxs(Fy,{onClick:k,children:[l.jsx($y,{src:c}),l.jsx(zy,{children:d})]}),l.jsxs(Ia,{children:[l.jsx(Uy,{children:u.title}),l.jsx(Oa,{children:u.content})]}),l.jsx(By,{children:l.jsx(Hy,{children:l.jsx(Wy,{children:u.topic})})}),l.jsxs(Yy,{children:[l.jsxs(Mo,{children:[l.jsx("div",{onClick:h,children:o?l.jsx(Vy,{icon:U1}):l.jsx(yl,{icon:Gy})}),l.jsxs("div",{children:[u.likes," likes"]})]}),l.jsxs(Mo,{children:[l.jsx(yl,{icon:Ky}),l.jsxs("div",{children:[u.getCommentsTotal()," comments"]})]}),l.jsx(Mo,{children:l.jsx("div",{children:u.reactions})})]}),l.jsx(mp,{id:a,level1:-1,level2:-1,onReplySuccess:e,closeForm:f,isGuestView:t})]})})}function vP({user:e,level1:t,level2:n,handleRerenderThread:r,isGuestView:o},i){const{author:a,content:s}=e,[u,c]=x.useState(!1),{id:d}=ei(),f=()=>{c(!1)};return l.jsx(l.Fragment,{children:l.jsxs(ex,{children:[l.jsx(tx,{}),l.jsxs(dp,{children:[l.jsxs(fp,{children:[l.jsx(pp,{src:a.getProfilePicture()}),l.jsx(hp,{children:a.getUsername()})]}),l.jsx("br",{}),l.jsx(Ia,{children:l.jsx(Oa,{children:s})}),l.jsx("br",{}),l.jsx(mp,{id:d,level1:t,level2:0,closeForm:f,onReplySuccess:r,isGuestView:o})]})]})})}function nx({user:e,level1:t,handleRerenderThread:n,isGuestView:r},o){const{author:i,content:a}=e,[s,u]=x.useState(!1),{id:c}=ei(),d=()=>{u(!1)};return l.jsx(l.Fragment,{children:l.jsxs(dp,{children:[l.jsxs(fp,{children:[l.jsx(pp,{src:i.getProfilePicture()}),l.jsx(hp,{children:i.getUsername()})]}),l.jsx("br",{}),l.jsx(Ia,{children:l.jsx(Oa,{children:a})}),l.jsx("br",{}),l.jsx(mp,{id:c,level1:t,level2:-1,closeForm:d,onReplySuccess:n,isGuestView:r})]})})}nx.propTypes={user:H.object};function yP({user:e}){const{author:t,content:n}=e;return l.jsx(l.Fragment,{children:l.jsxs(ex,{children:[l.jsx(tx,{}),l.jsxs(dp,{children:[l.jsxs(fp,{children:[l.jsx(pp,{src:t.getProfilePicture()}),l.jsx(hp,{children:t.getUsername()})]}),l.jsx("br",{}),l.jsx(Ia,{children:l.jsx(Oa,{children:n})}),l.jsx("br",{})]})]})})}const xP=y.div`
    display: flex;
    align-items: center;
    justify-content: center;
    width: 50px;
...
`,$P=y.div`
    font-size: 17px;
    color: var(--white);
`;function ft({user:e,text:t}){return l.jsx(AP,{children:l.jsxs(LP,{children:[l.jsxs(MP,{children:[l.jsx(_P,{src:e.profilePic}),l.jsx(DP,{children:e.userName})]}),l.jsx(FP,{children:l.jsx($P,{children:e.message})})]})})}const ag={message:"Words words words words. Words words words.",userName:"PixelPioneer",profilePic:Hl},ms={message:"Words words words words. Words words words.",userName:"Kirby",profilePic:Jr},zP={userName:"Boo",profilePic:qr},UP={userName:"Sonic",profilePic:Zr};function BP(){const e=lt(),t="/CodeConnect/dm-boo",n="/CodeConnect/dm-kirby",r="/CodeConnect/dm-sonic",o=()=>{e("/CodeConnect/profile/Kirby")};return l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(SP,{children:[l.jsx(bP,{children:l.jsxs(CP,{children:[l.jsxs(PP,{children:[l.jsx(vp,{src:Jr}),l.jsx(gp,{onClick:o,children:"Kirby"}),l.jsx(OP,{to:"/CodeConnect/direct-messages",children:"X"})]}),l.jsxs(TP,{children:[l.jsx(ft,{user:ms}),l.jsx(ft,{user:ag}),l.jsx(ft,{user:ms}),l.jsx(ft,{user:ag}),l.jsx(ft,{user:ms})]}),l.jsxs(RP,{children:[l.jsx(IP,{rows:"2",cols:"20"}),l.jsx(NP,{children:"Send"})]})]})}),l.jsxs(jP,{children:[l.jsx(EP,{children:l.jsx(ql,{children:"Messages"})}),l.jsx(zt,{user:zP,url:t}),l.jsx(zt,{user:ms,url:n}),l.jsx(zt,{user:UP,url:r})]}),l.jsx(eu,{to:"/CodeConnect/new-direct-message",children:"New +"})]})]})}const HP=y.div`
    margin-left: 20vw;
    display: flex;
    width: 80vw;
    height: 100vh;
...
`,sg={message:"Words words words words. Words words words.",userName:"PixelPioneer",profilePic:Hl},eT={userName:"Kirby",profilePic:Jr},gs={message:"HAHAHHAHAHAH.",userName:"Boo",profilePic:qr},tT={userName:"Sonic",profilePic:Zr};function nT(){const e=lt(),t="/CodeConnect/dm-boo",n="/CodeConnect/dm-kirby",r="/CodeConnect/dm-sonic",o=()=>{e("/CodeConnect/profile/Boo")};return l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(HP,{children:[l.jsx(WP,{children:l.jsxs(YP,{children:[l.jsxs(KP,{children:[l.jsx(vp,{src:qr}),l.jsx(gp,{onClick:o,children:"Boo"}),l.jsx(qP,{to:"/CodeConnect/direct-messages",children:"X"})]}),l.jsxs(XP,{children:[l.jsx(ft,{user:gs}),l.jsx(ft,{user:sg}),l.jsx(ft,{user:gs}),l.jsx(ft,{user:sg}),l.jsx(ft,{user:gs})]}),l.jsxs(QP,{children:[l.jsx(JP,{rows:"2",cols:"20"}),l.jsx(ZP,{children:"Send"})]})]})}),l.jsxs(GP,{children:[l.jsx(VP,{children:l.jsx(ql,{children:"Messages"})}),l.jsx(zt,{user:gs,url:t}),l.jsx(zt,{user:eT,url:n}),l.jsx(zt,{user:tT,url:r})]}),l.jsx(eu,{to:"/CodeConnect/new-direct-message",children:"New +"})]})]})}const rT=y.div`
    margin-left: 20vw;
    display: flex;
    width: 80vw;
    height: 100vh;
...
`,lg={message:"Words words words words. Words words words.",userName:"PixelPioneer",profilePic:Hl},hT={userName:"Kirby",profilePic:Jr},mT={userName:"Boo",profilePic:qr},vs={message:"Gotta go fast bro",userName:"Sonic",profilePic:Zr};function gT(){lt();const e="/CodeConnect/dm-boo",t="/CodeConnect/dm-kirby",n="/CodeConnect/dm-sonic";return l.jsxs(It,{children:[l.jsx(mn,{}),l.jsxs(rT,{children:[l.jsx(oT,{children:l.jsxs(iT,{children:[l.jsxs(lT,{children:[l.jsx(vp,{src:Zr}),l.jsx(gp,{children:"Sonic"}),l.jsx(pT,{to:"/CodeConnect/direct-messages",children:"X"})]}),l.jsxs(uT,{children:[l.jsx(ft,{user:vs}),l.jsx(ft,{user:lg}),l.jsx(ft,{user:vs}),l.jsx(ft,{user:lg}),l.jsx(ft,{user:vs})]}),l.jsxs(cT,{children:[l.jsx(fT,{rows:"2",cols:"20"}),l.jsx(dT,{children:"Send"})]})]})}),l.jsxs(sT,{children:[l.jsx(aT,{children:l.jsx(ql,{children:"Messages"})}),l.jsx(zt,{user:mT,url:e}),l.jsx(zt,{user:hT,url:t}),l.jsx(zt,{user:vs,url:n})]}),l.jsx(eu,{to:"/CodeConnect/new-direct-message",children:"New +"})]})]})}function vT({isGuestView:e}){const{id:t}=ei(),{state:n}=qo(),{results:r,searchTerm:o}=n,i=()=>{window.history.go(-1)};console.log({results:r});let a=[];return st.forEach(s=>{s.name===t&&s.posts.forEach(u=>{a.push(u)})}),console.log({topics:a}),l.jsxs(It,{children:[e?l.jsx(Jl,{}):l.jsx(mn,{}),l.jsx(Ly,{children:l.jsxs(aP,{children:[l.jsxs(Ay,{children:[l.jsx(lP,{onClick:i,children:l.jsx(qy,{icon:op})}),l.jsx(uP,{children:l.jsx(cp,{data:re})})]}),l.jsxs(sP,{children:[a.length>2||a.length==0?l.jsxs(rg,{children:[a.length,' results found matching "',o,'"']}):l.jsxs(rg,{children:[a.length,' result found matching "',o,'"']}),l.jsx(Jy,{children:a.map((s,u)=>l.jsx(Aa,{information:s},u))})]})]})})]})}const yT=Hk([{path:"/CodeConnect/",element:l.jsx(Vb,{})},{path:"/CodeConnect/home",element:l.jsx(u4,{})},{path:"/CodeConnect/explore",element:l.jsx(tg,{isGuestView:0})},{path:"/CodeConnect/guest-explore",element:l.jsx(tg,{isGuestView:1})},{path:"/CodeConnect/direct-messages",element:l.jsx(X4,{})},{path:"/CodeConnect/dm-kirby",element:l.jsx(BP,{})},{path:"/CodeConnect/dm-boo",element:l.jsx(nT,{})},{path:"/CodeConnect/dm-sonic",element:l.jsx(gT,{})},{path:"/CodeConnect/new-direct-message",element:l.jsx(O4,{})},{path:"/CodeConnect/profile/:userName",element:l.jsx(s4,{})},{path:"/CodeConnect/guest-home",element:l.jsx(A4,{})},{path:"/CodeConnect/create-account",element:l.jsx(cP,{})},{path:"/CodeConnect/:author/:id",element:l.jsx(ig,{isGuestView:0})},{path:"/CodeConnect/guest-view/:author/:id",element:l.jsx(ig,{isGuestView:1})},{path:"/CodeConnect/explore-results/:id",element:l.jsx(vT,{})}]),xT=nc.createRoot(document.getElementById("root"));xT.render(l.jsxs("div",{children:[l.jsx(l4,{}),l.jsx(Zk,{router:yT})]}));
